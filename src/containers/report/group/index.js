            ...
            <div className={css.content}>
                <header className={css.header}>
                    <div className={css.title}>
                        ...
                        <br /><span className={css.subtitle}>{this.state.qsparams.type == '2' ? '班级' : '集体'}分析报告</span>
                    </div>
                ...
                {!this.state.report.hideWarningMsg && <div className={css.warninginfo}>
                    ...
                    { this.state.report.warnStudentList && this.state.report.warnStudentList.length && <div>
